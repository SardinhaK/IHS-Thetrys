...
static long int my_ioctl(struct file*, unsigned int cmd, unsigned long arg)
{
	...
	case RD_SWITCHES:
		...
		break;
	case RD_PBUTTONS:
		read_pointer = bar0_mmio + 0xC500; //TODO: update offset
		rd_name_idx = IDX_PBUTTONS;
		break;
	case WR_L_DISPLAY:
		write_pointer = bar0_mmio + 0xC200; //TODO: update offset
	...
	case WR_R_DISPLAY:
		...
		break;
	case WR_RED_LEDS:
		write_pointer = bar0_mmio + 0xC400; //TODO: update offset
		wr_name_idx = IDX_DISPLAYR;
		break;
	case WR_GREEN_LEDS:
		write_pointer = bar0_mmio + 0xC300; //TODO: update offset
		wr_name_idx = IDX_DISPLAYR;
		break;
	default:
